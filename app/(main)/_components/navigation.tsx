  ...
  return (
    <>
      ...
      >
        ...
        <div className="mt-4">
          <DocumentList />
          <Item label="Add a document" icon={Plus} onClick={handleCreate} />
          <Popover>
        ...
        <div
          ...
          onClick={resetWidth}
          className="opacity-0 group-hover/sidebar:opaciy-100 transition cursor-ew-resize absolute h-full w-1 bg-primary/10 right-0 top-0"
        />
      </aside>
      <div
        ref={navbarRef}
